      ...
      <div className="max-w-md mx-auto">
        <div className="card text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your resource has been successfully booked. You&apos;ll receive a confirmation email shortly.
          </p>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Reserve shared resources with automatic conflict detection</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className={`input-field ${errors.resource ? "border-red-500 ring-red-500" : ""}`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`input-field ${errors.startTime ? "border-red-500 ring-red-500" : ""}`}
            ...
            <div>
              ...
              <input
                ...
                className={`input-field ${errors.endTime ? "border-red-500 ring-red-500" : ""}`}
          ...
          <div>
            ...
            <input
              ...
              className={`input-field ${errors.requestedBy ? "border-red-500 ring-red-500" : ""}`}
            />
            {errors.requestedBy && (
              <p className="mt-1 text-sm text-red-600 flex items-center">
                <AlertCircle className="w-4 h-4 mr-1" />
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="text-sm font-medium text-blue-900 mb-1">Buffer Time Policy</h4>
                <p className="text-sm text-blue-700">
                  A 10-minute buffer is automatically added before and after each booking to prevent conflicts. Your
                  actual booking time will be protected with this buffer zone.
                </p>
              </div>
            </div>
          </div>
